...
# Version 0.1
# Script included with dataset

# MODIFIED TO INCLUDE COMPATIBILITY WITH tweepy
# FOR THE PURPOSES OF THE PROJECT BY: Wally Niu
# RUNS ON PYTHON 2

import csv, getpass, json, os, time, urllib, tweepy, io
...
def download_tweets( fetch_list, raw_dir ):
    ...
    max_tweets_per_hr  = 750
    download_pause_sec = 3600 / max_tweets_per_hr
    # REPLACE WITH TWITTER OAUTH KEYS
    ...
    for idx in range(0,len(fetch_list)):
        ...
        try:
            ...
            with open(raw_dir + str(tweet_id) + '.json', 'w') as fp:
                json_str = json.dump(tweet._json,  fp)
            # pull data
